...
export function CreateQuestionGraphConstructor() : QuestionGraphConstructor{
    return {
        segment : [],
        ellipse : [],
        text : [],
...
export class QuestionGraph extends PIXI.Container {
    ...
    private animGraph!: PIXI.Graphics;
    ...
    constructor(initializer: QuestionGraphConstructor) {
        ...
        this.animGraph = new PIXI.Graphics();
        this.addChild(this.animGraph);
